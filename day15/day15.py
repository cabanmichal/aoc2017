...
def generator(start_value, factor, picky_value=1):
    while True:
        next_value = start_value * factor % 2147483647
        if next_value % picky_value == 0:
            yield next_value
...
if __name__ == '__main__':
    ...
    for _ in range(40000000):
        valid_pairs += compare_values(next(gen_a), next(gen_b))

    print(valid_pairs)  # 573
